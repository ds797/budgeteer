		...
		<div class="container">
			...
			<div class="icon">
				{ #if category.overflow?.category }
					{ #if category.spend }
						<svg xmlns="http://www.w3.org/2000/svg" class="underflow" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" transition:scale>
							<path stroke-linecap="round" stroke-linejoin="round" d="m9 9 6-6m0 0 6 6m-6-6v12a6 6 0 0 1-12 0v-3" />
						</svg>
					{ :else }
						<svg xmlns="http://www.w3.org/2000/svg" class="overflow" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" transition:scale>
